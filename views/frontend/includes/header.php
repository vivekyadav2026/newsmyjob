...
@media (max-width: 575.98px) {
    .site-logo-title { font-size: 1.35rem; letter-spacing: -0.5px; }
    .site-logo-subtitle { font-size: 7.5px; letter-spacing: 1px; margin-top: 2px !important; }
    .site-logo-img { height: 32px; }
    .navbar-brand.gap-2 { gap: 8px !important; }
}
</style>
