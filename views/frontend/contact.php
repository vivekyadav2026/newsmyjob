...
<div class="container my-5">
    ...
    <div class="bg-dark text-white p-4 p-md-5 rounded shadow-sm mb-5 position-relative overflow-hidden" style="border-left: 5px solid var(--primary-color) !important;">
        <div class="position-relative z-1" style="z-index: 2;">
            <h1 class="display-4 fw-bold font-merriweather mb-3"><i class="bi bi-headset text-danger me-3"></i>Get in Touch</h1>
            <p class="fs-5 text-light opacity-75 fst-italic mb-0">Have a story? Want to advertise? Or just want to say hi? We'd love to hear from you.</p>
        </div>
        <i class="bi bi-chat-quote position-absolute text-white opacity-10" style="font-size: 15rem; right: -2rem; top: -3rem; transform: rotate(-15deg); z-index: 1;"></i>
    </div>
