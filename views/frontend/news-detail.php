    ...
    <div class="row mt-4">
        <div class="col-lg-8">
            <header class="article-header mb-4">
                ...
                <div class="article-meta-bar py-3 border-top border-bottom d-flex flex-wrap gap-4 bg-light px-3 rounded">
                    <div class="author-card">
                        <img src="<?= asset('images/placeholder.svg') ?>" class="author-avatar shadow-sm">
                        <div>
                            <div class="fw-bold text-dark" style="font-size: 14px;">By <?= e($article['author_name']) ?></div>
                            <div class="text-muted" style="font-size: 12px;">NewsMyJob Desk</div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <span class="text-muted small fw-bold me-2 align-self-center">Text Size</span>
